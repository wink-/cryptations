...
function Example.Interrupt(TargetToInterrupt)
  -- Kick()
...
-- You can either put a function here which is defined in the Class-Abilities.lua or Class-Common.lua or use conditions here.
function Example.Taunt(TargetToTaunt)
  -- Growl()
...
-- You can either put a function here which is defined in the Class-Abilities.lua or Class-Common.lua or use conditions here.
function Example.Dispell(TargetToDispell, DispellType)
 -- CleanseToxins()
